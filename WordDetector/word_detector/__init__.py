...
def detect(img: np.ndarray,
           ...
           min_area: int,
           sigma_x: float = None,
           sigma_y: float = None) -> List[DetectorRes]:
    ...
    Args:
        ...
        sigma_x: Optional custom sigma for x-direction.
        sigma_y: Optional custom sigma for y-direction.
    ...
    # apply filter kernel
    kernel = _compute_kernel(kernel_size, sigma_x or sigma * theta, sigma_y or sigma)
